    ...
    function create_fragment$k(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div9 = element("div");
    			h1 = element("h1");
    			t0 = text("Cryptoland Just Entered ");
    			span0 = element("span");
    			span0.textContent = "the Real World";
    			t2 = space();
    			p = element("p");
    			...
    			a0 = element("a");
    			span1 = element("span");
    			span1.textContent = "Buy Tokens 47% Off";
    			t15 = space();
    			a1 = element("a");
    			a1.textContent = "WhitePappers";
    			t17 = space();
    			div8 = element("div");
    			img0 = element("img");
    			t18 = space();
    			...
    			div12 = element("div");
    			img5 = element("img");
    			add_location(span0, file$k, 4, 44, 192);
    			add_location(h1, file$k, 4, 16, 164);
    			add_location(p, file$k, 5, 16, 241);
    			attr_dev(div0, "id", "timer");
    			attr_dev(div0, "class", "timer");
    			add_location(div0, file$k, 10, 20, 507);
    			add_location(div1, file$k, 12, 24, 616);
    			add_location(div2, file$k, 13, 24, 656);
    			add_location(div3, file$k, 14, 24, 697);
    			add_location(div4, file$k, 15, 24, 740);
    			attr_dev(div5, "class", "timer__titles");
    			add_location(div5, file$k, 11, 20, 564);
    			attr_dev(div6, "class", "timer-wrap");
    			add_location(div6, file$k, 9, 16, 462);
    			add_location(span1, file$k, 20, 68, 925);
    			attr_dev(a0, "href", "#");
    			attr_dev(a0, "class", "btn btn--medium btn--orange");
    			add_location(a0, file$k, 20, 20, 877);
    			attr_dev(a1, "href", "#");
    			attr_dev(a1, "class", "btn btn--big btn--blue");
    			add_location(a1, file$k, 21, 20, 981);
    			attr_dev(div7, "class", "promo__btns-wrap");
    			add_location(div7, file$k, 19, 16, 826);
    			if (!src_url_equal(img0.src, img0_src_value = "img/visa.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "");
    			add_location(img0, file$k, 25, 20, 1124);
    			if (!src_url_equal(img1.src, img1_src_value = "img/mc.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			add_location(img1, file$k, 26, 20, 1176);
    			if (!src_url_equal(img2.src, img2_src_value = "img/bitcoin.png")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "");
    			add_location(img2, file$k, 27, 20, 1226);
    			if (!src_url_equal(img3.src, img3_src_value = "img/paypal.png")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "");
    			add_location(img3, file$k, 28, 20, 1281);
    			attr_dev(div8, "class", "payments");
    			add_location(div8, file$k, 24, 16, 1081);
    			...
    			add_location(img4, file$k, 32, 8, 1380);
    			...
    			attr_dev(img5, "alt", "");
    			add_location(img5, file$k, 36, 8, 1505);
    			attr_dev(div12, "class", "scroll-down");
    			add_location(div12, file$k, 35, 4, 1471);
